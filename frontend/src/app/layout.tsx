...
export default function RootLayout({
    ...
    return (
        <html lang="en" className="scroll-smooth">
            <body
                className={`${SFPro.className} antialiased flex flex-col m-auto`}
            >
                <header className="shadow-2xs py-4">
                    <div className="px-4 md:px-0 md:w-7xl flex justify-between items-center gap-4 m-auto">
                        ...
                        <div className="hidden md:flex items-baseline gap-9">
                            <Link href="/main#petition">Текст петиции</Link>
                            <Link href="/main#how-it-works">Как работает</Link>
                            <Link href="/main/status">Текущий статус</Link>
                            <Link href="/main">Контакты</Link>
                            <LangSwitch />
                        </div>
                ...
                <footer className="bg-[#F2F2F2] py-6">
                    <div className="px-6 md:px-0 md:w-7xl m-auto">
