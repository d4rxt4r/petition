...
export enum PetitionStatusCode {
    ACTIVE,
    PENDING,
    SIGNED,
    REJECTED,
...
export const PetitionStatusMap = {
    [PetitionStatus.ACTIVE]: PetitionStatusCode.ACTIVE,
    [PetitionStatus.PENDING]: PetitionStatusCode.PENDING,
    [PetitionStatus.SIGNED]: PetitionStatusCode.SIGNED,
    [PetitionStatus.REJECTED]: PetitionStatusCode.REJECTED,
};
